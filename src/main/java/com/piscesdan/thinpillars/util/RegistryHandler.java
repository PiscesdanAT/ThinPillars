...
public class RegistryHandler
{
    ...
    public static final RegistryObject<Item> ANDESITE_THIN_PILLAR_ITEM = ITEMS.register("andesite_thin_pillar", () -> new BlockItem(ANDESITE_THIN_PILLAR.get(), quarkGroup));
    ...
    public static final RegistryObject<Item> DIORITE_THIN_PILLAR_ITEM = ITEMS.register("diorite_thin_pillar", () -> new BlockItem(DIORITE_THIN_PILLAR.get(), quarkGroup));
    public static final RegistryObject<Item> GRANITE_THIN_PILLAR_ITEM = ITEMS.register("granite_thin_pillar", () -> new BlockItem(GRANITE_THIN_PILLAR.get(), quarkGroup));
